...
#atac.PT.TCM.track <- DataTrack(range = atac.PT.TCM, type = "h", genome = "hg19", name = "ATAC.PT.TCM", col = "navy", showAxis=FALSE, ylim = c(0, 1))
...
```{r,echo=FALSE}
pcHic <- read.table("./data/chicago-dPL5-dec.ibed",header = TRUE)
...
snp.p2 = 138843356
list.of.tracks <- c()
ht1 <- HighlightTrack(c(pval.track, pip.track, atac.PT.dec.track, gene.track, hic.track, axisTrack), 
